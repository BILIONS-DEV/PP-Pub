...
type PayloadReportAdsenseIndex struct {
	datatable.Request
...
type PayloadReportAdsenseIndexPost struct {
	datatable.Request
	UserID   int64                                   `json:"user_id"`
	PostData *PayloadReportAdsenseIndexPostData `query:"postData"`
}

type PayloadReportAdsenseIndexPostData struct {
...
func (t *PayloadReportAdsenseIndexPost) Validate() (errs []Error) {
	return
}
