const formID = "#formFilterContent"
const tableID = "#tableContents"
const filterURL = "/content";
const currentURL = "/content";
let firstLoad = true;
...
$(document).ready(function () {
    ...
    $(tableID).on("click", "tbody td div.link_video div.d-block a", function (e) {
        e.preventDefault()
        ShowVideo($(this))
...
function GetTable(isClickForm = false) {
    ...
    let setting = {
        ...
        columns: [
            ...
            {data: "type", name: "Type"},
            // {data: "content_desc", name: "Content Description"},
            // {data: "video_url", name: "Video URL"},
            // {data: "thumb", name: "Thumb"},
            // {data: "category", name: "Category"},
            // {data: "tags", name: "Tags"},
            // {data: "video_type", name: "Video Type"},
...
function Delete(id) {
    ...
    $.ajax({
        ...
        switch (result.status) {
            case "success":
                NoticeSuccess("Content has been removed successfully")
                GetTable(false)
                break
            case "err":
