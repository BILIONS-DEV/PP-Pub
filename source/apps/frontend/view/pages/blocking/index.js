const formID = "#formFilterBlocking"
const tableID = "#tableBlocking"
const filterURL = "/blocking";
const currentURL = "/blocking";
let firstLoad = true;
...
function GetTable(isClickForm = false) {
    ...
    let setting = {
        ...
        columns: [
            // {data: "id", name: "ID"},
            {data: "restriction_name", name: "RESTRICTION NAME"},
...
function Delete(id) {
    ...
    $.ajax({
        ...
        switch (result.status) {
            case "success":
                NoticeSuccess("Blocking has been removed successfully")
                GetTable(false)
                break
            case "err":
