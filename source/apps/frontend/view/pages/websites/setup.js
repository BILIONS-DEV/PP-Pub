...
function changeStatusConnection(clickElement) {
    ...
    $.ajax({
        url: "/websites/change-status-connection",
        type: "POST",
        dataType: "JSON",
        data: {
...
function HandleSubmit() {
    submitFormSetup("formGeneral", "/websites/setup", SetUp)
    submitFormConsent("formConsent", "/websites/setupConsent", SetUp)
    submitFormUser("formUserId", "/websites/setupUserId", SetUp)
}
        ...
        switch (value) {
            ...
            case "5":
                ...
                $("#BoxAdtag").find('#size_sticky_mobile').empty()
                    .append(appendOptionAdSize(7)).append(appendOptionAdSize(9)).append(appendOptionAdSize(19)).append(appendOptionAdSize(20)).selectpicker('refresh')
                break;
...
function SubmitFormCreate(formID, functionCallback, ajaxUrl = "") {
    ...
    formElement.find(".submit-adtag").on("click", function (e) {
        ...
        if (postData.sticky4k === "on") {
            postData.sticky4k = "on"
        } else {
            postData.sticky4k = "off"
        }
        $.ajax({
            url: ajaxUrl,
            type: "POST",
