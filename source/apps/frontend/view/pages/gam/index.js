const formID = "#formFilterGam"
const tableID = "#tableGam"
const filterURL = "/gam";
const currentURL = "/gam";
let firstLoad = true;
...
function GetTable(isClickForm = false) {
    ...
    let setting = {
        ...
        columns: [
            {data: "network_id", name: "Gam Network ID"},
            {data: "network_name", name: "Gam Network Name"},
            {data: "api_access", name: "API Enabled"},
            {data: "create_at", name: "Date Pushed"},
            {data: "set_up", name: "SetUp"},
        ],
