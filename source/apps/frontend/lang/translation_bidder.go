...
type Bidder struct {
	...
	View               TYPETranslation `json:"view"`
	...
	ImportXlsx         TYPETranslation `json:"import_xlsx"`
	ImportXlsxDesc     TYPETranslation `json:"import_xlsx_desc"`
	RPM                TYPETranslation `json:"rpm"`
}
