...
type User struct {
	...
	IFSCCode          TYPETranslation `json:"ifsc_code"`
	...
	Address           TYPETranslation `json:"address"`
	City              TYPETranslation `json:"city"`
	State             TYPETranslation `json:"state"`
	ZipCode           TYPETranslation `json:"zip_code"`
	Country           TYPETranslation `json:"country"`
	PhoneNumber       TYPETranslation `json:"phone_number"`
